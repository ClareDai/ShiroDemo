...
<div class="container">
	...
	<div class="panel panel-default">
	  ...
	  <div class="panel-body">
		...
		<button id="admin" type="button" class="btn btn-primary">admin角色操作</button>
		<button id="manager" type="button" class="btn btn-primary">manager角色操作</button>
		<button id="normal" type="button" class="btn btn-primary">normal角色操作</button>
	  </div>
	</div>
</div>
